...
SXdarkCam = SXcam_Nimg(hCam, 0, 100, NpxX/2, NpxY/2, NpxX/2, NpxY/2, 0, 0, 10);
...
% save('C:\Users\cdelacroix\HeSun\BB\SXdarkCam.mat', 'SXdarkCam')

%% Wide Field
% 100ms at laser 25 (425/681, 509) -> 2ms at laser 47
% superK 80ms (392/646 ,484) -> 400ms
[A,x,y,SAT]=SXcam_Nimg(hCam, SXdarkCam, 80, Xc, Yc, RX, RY, 0, 0, 1);
