function [EfocalEst, IincoEst, data] = EKF3b_r1(u, image, darkHole, model, estimator, controller, data, kWavelength)
...
%     xPosteriori = xOld + K * residual; % update a posteriori state
%     estimate (open loop case)
